...
RSpec.describe User, type: :model do
  ...
  describe 'Validations' do
    ...
    it 'is not valid with a duplicate email (case insensitive)' do
      ...
      duplicate_user = User.new(valid_attributes.merge(email: 'TEST@gmail.com'))
  ...
  describe '.authenticate_with_credentials' do
    ...
    context 'when credentials are correct' do
      it 'returns the user when the correct email and password are provided' do
        user = User.authenticate_with_credentials('johnjohnny@gmail.com', 'qwe123')
    ...
    context 'when credentials are incorrect' do
      ...
      it 'returns nil when the password is incorrect' do
        user = User.authenticate_with_credentials('johnjohnny@gmail.com', 'wrongpassword')
        expect(user).to be_nil
      end
